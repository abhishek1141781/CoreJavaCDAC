...
//		bankAccount.add(new BankAccount(1141781,"Arshavin","FD",340000,"2020-02-02"));
		bankAccount.add(new BankAccount(1146,"Arshavin",AccountType.valueOf("CURRENT"),340000,LocalDate.of(2003, 02, 01)));
		bankAccount.add(new BankAccount(1144,"Andrey",AccountType.valueOf("LOAN"),340000,LocalDate.of(2012, 03, 01)));
		bankAccount.add(new BankAccount(1143,"Ballack",AccountType.valueOf("SAVINGS"),340000,LocalDate.of(2021, 04, 01)));
		bankAccount.add(new BankAccount(1142,"Drogba",AccountType.valueOf("NRO"),340045,LocalDate.of(2020, 05, 01)));
		bankAccount.add(new BankAccount(1145,"Lampard",AccountType.valueOf("NRE"),770000,LocalDate.of(2021, 07, 01)));
		bankAccount.add(new BankAccount(1141,"Gerrard",AccountType.valueOf("FD"),380000,LocalDate.of(2004, 05, 01)));
		
		return bankAccount;
	}
	
	public static Map<Integer, BankAccount> populateHashMap(List<BankAccount> list){
		Map<Integer, BankAccount> hashMap = new HashMap<Integer, BankAccount>();
		
		for(BankAccount b : list) {
			hashMap.put(b.getAccountNumber(), b);
		}
