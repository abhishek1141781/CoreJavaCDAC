...
//add a static method to validate manu. date : must be in current  year
	...
	public static void checkForDup(Map<String,Vehicle> hashMap, String chasisNo) throws InvalidInputException {
//		Vehicle is a raw type. References to generic type Vehicle<Vehicle> should be parameterized
...
//		Vehicle newVehicle=new Vehicle(chasisNo);
		if(hashMap.containsKey(chasisNo))
			throw new InvalidInputException("Dup ch no , Vehicle can't be added!!!!!!");
