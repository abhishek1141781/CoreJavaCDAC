...
//	}
	...
	public static void checkIfAccountExists(int accountNumber, List<BankAccountCA> list) throws InvalidInputException{
		BankAccountCA b1=new BankAccountCA(accountNumber);
		if(!list.contains(b1)) {
...
//		public static void withdraw(List<BankAccountCA> bankingList, double withdrawAmt, int accountNum)
//		{
//			BankAccountCA bank= new BankAccountCA(accountNum);
//			int index=bankingList.indexOf(bank);
//		BankAccountCA bank1=bankingList.g
//			}
