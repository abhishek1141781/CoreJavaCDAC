...
//				why is there no new for local date. is no instance created here
			...
			case 3://Withdraw
				...
				ValidationRules.checkIfAccountExists(accountNum, bankingList);
				
				System.out.println("Pls enter withdrawl ammount: ");
				double withdrawAmt = sc.nextDouble();
				
				accountNumWithRef.withdraw(bankingList, withdrawAmt,accountNum);
			...
			case 4://Deposit
				...
				ValidationRules.checkIfAccountExists(accountNumDep, bankingList);
