...
//			throws InvalidInputExceptionBankAccount{
	...
	public static void checkForDupAccount(Map<Integer, BankAccount> map, int accountNumber)
			throws InvalidInputExceptionBankAccount {
...
//	add a public method to validated if entered account doesn't exist in database
	...
	public static void bankAccountExists(int accountNumber, Map<Integer, BankAccount> bankAccountMap)
			throws InvalidInputExceptionBankAccount {
