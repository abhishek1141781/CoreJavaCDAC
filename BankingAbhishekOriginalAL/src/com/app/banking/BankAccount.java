...
//	}
	...
	public void withdraw(List<BankAccount> list, int accountNumber, double withdrawAmount) {
...
//		return thisetAccountBalance(this.getAccountBalance()-withdrawAmount);
	...
	public static void fundTransferUsingWD(List<BankAccount> list,int senderAccountNumber, int recieverAccountNumber, double transferAmount) {
		BankAccount srcacc =  list.get(list.indexOf(new BankAccount(senderAccountNumber)));
		BankAccount tgtacc =  list.get(list.indexOf(new BankAccount(recieverAccountNumber)));
...
//		withdraw from invokee account
		srcacc.withdraw(list, senderAccountNumber, transferAmount);
//		deposit to said account
		tgtacc.deposit(list, recieverAccountNumber, transferAmount);
